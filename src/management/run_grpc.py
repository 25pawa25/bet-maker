...
from clients.grpc.proto.bet import bet_pb2_grpc
from clients.grpc.servicer.bet import get_bet_servicer
...
class Command(BaseCommand):
    ...
    async def start_server(self, host: str, port: int):
        ...
        bet_pb2_grpc.add_BetServicer_to_server(servicer, server)
